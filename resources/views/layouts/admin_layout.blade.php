            ...
            <div class="header-right">
                <ul class="clearfix">
                    ...
                    <li class="icons dropdown"><a href="javascript:void(0)" data-toggle="dropdown">
                            ...
                            <span class="badge badge-pill gradient-1">{{$pochta_c_l}}</span>
                        </a>
                        <div class="drop-down animated fadeIn dropdown-menu">
                            <div class="dropdown-content-heading d-flex justify-content-between">
                                <span class="">{{$pochta_c_l}} New Contact Messages</span>
                            ...
                            <div class="dropdown-content-body">
                                <ul>
                                    @foreach($email_l as $item)
                                    <li class="notification-unread">
                                        <a href="javascript:void()">
                                            <img class="float-left mr-3 avatar-img" src="{{asset('adminaka/images/avatar/astronaut.png')}}" alt="">
                                            <div class="notification-content">
                                                <div class="notification-heading">{{$item->name}}</div>
                                                <div class="notification-timestamp">{{$item->getNewsDate()}}</div>
                                    ...
                                    @endforeach
                                        <li>
                                            <a href="{{route('pochta.index')}}" class="btn btn-outline-danger btn-block""><i class="icon-plane"></i> <span>View All</span></a>
                                        </li>
                                </ul>
                    ...
                    @if($reg_c_l>0)
                            <li class="icons dropdown"><a href="javascript:void(0)" data-toggle="dropdown">
                                    ...
                                    <span class="badge badge-pill gradient-2 badge-primary">{{$reg_c_l}}</span>
                                </a>
                                <div class="drop-down animated fadeIn dropdown-menu">
                                    <div class="dropdown-content-heading d-flex justify-content-between">
                                        <span class="">{{$reg_c_l}} New Registered Pupils</span>
                                        <a href="javascript:void()" class="d-inline-block">
                                            <span class="badge badge-pill gradient-1">{{$reg_c_l}}</span>
                                        </a>
                                    </div>
                                    <div class="dropdown-content-body">
                                        <ul>
                                            @foreach($reg_l as $item)
                                                <li class="notification-unread">
                                                    <a href="javascript:void()">
                                                        <img class="float-left mr-3 avatar-img" src="{{asset('adminaka/images/avatar/astronaut.png')}}" alt="">
                                                        <div class="notification-content">
                                                            <div class="notification-heading">{{$item->name}}</div>
                                                            <div class="notification-text">+998{{$item->phone_number}}</div>
                                                            <div class="notification-timestamp">{{$item->getRegDate()}}</div>
                                                        </div>
                                                    </a>
                                                </li>
                                            @endforeach
                                                <li>
                                                    <a href="{{route('registration.index')}}" class="btn btn-outline-danger btn-block""><i class="icon-plane"></i> <span>View All</span></a>
                                                </li>
                                        </ul>
